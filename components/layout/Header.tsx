      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center flex-1 overflow-hidden">
             <button onClick={toggleSidebar} className="lg:hidden mr-2 p-2 rounded-md text-slate-500 hover:bg-slate-100 flex-shrink-0">
             ...
             <div className="flex items-center gap-2 overflow-hidden">
                ...
                <h1 className="text-lg sm:text-xl font-bold text-primary truncate">
                    <span className="md:hidden">Smart Kido</span>
          ...
          <div className="flex items-center space-x-2 sm:space-x-4 flex-shrink-0 ml-2">
            <div className="flex items-center space-x-1 sm:space-x-2">
              <span className={`font-semibold text-xs sm:text-base ${language === 'en' ? 'text-primary' : 'text-slate-400'}`}>EN</span>
              <label htmlFor="language-toggle" className="relative inline-flex items-center cursor-pointer">
                ...
                <div className="w-9 h-5 sm:w-11 sm:h-6 bg-slate-200 rounded-full peer peer-focus:ring-2 peer-focus:ring-primary-300 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-slate-300 after:border after:rounded-full after:h-4 after:w-4 sm:after:h-5 sm:after:w-5 after:transition-all peer-checked:bg-primary-600"></div>
              </label>
              <span className={`font-semibold text-xs sm:text-base ${language === 'sw' ? 'text-primary' : 'text-slate-400'}`}>SW</span>
            </div>
